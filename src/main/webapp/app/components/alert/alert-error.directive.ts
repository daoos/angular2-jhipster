(function() {
    ...
    angular
        .module('angular2JhipsterApp.common')
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('angular2JhipsterApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-angular2JhipsterApp-error');
                var entityKey = httpResponse.headers('X-angular2JhipsterApp-params');
                if (errorHeader) {
